        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CountChairs = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Table_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CookingTimeMin = table.Column<int>(type: "int", nullable: false),
                    PizzasSizeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BeverageOrder_Order_OrdersId",
                        column: x => x.OrdersId,
            ...
            migrationBuilder.InsertData(
                table: "Pizzas",
                columns: new[] { "Id", "CookingTimeMin", "Description", "Name", "PizzasSizeId", "Price" },
                values: new object[,]
                {
                    { 1, 30, "Good!", "Margherita", 1, 10m },
                    { 2, 30, "Good!", "Pepperoni", 1, 12m },
                    { 3, 30, "Cool!", "Hawaiian", 1, 11m },
                    { 4, 30, "Very good!", "Meat Lover's", 1, 13m },
                    { 5, 30, "Very good!", "Veggie Supreme", 1, 11m },
                    { 6, 30, "Good!", "BBQ Chicken", 1, 12m },
                    { 7, 30, "Very good!", "Supreme", 1, 10m },
                    { 8, 30, "Good!", "Cheese Lover's", 1, 11m },
                    { 9, 30, "Cool!", "Buffalo Chicken", 1, 12m },
                    { 10, 30, "Cool!", "Mediterranean", 1, 13m }
                });
